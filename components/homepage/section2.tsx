...
{/* "At SSICRS, you will:" Section - slightly above bottom */}
<div className="absolute" style={{ bottom: '6rem', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
