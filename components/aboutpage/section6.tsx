    ...
    <section className="w-full bg-[#FBFAF2] relative flex justify-center items-center pt-4 pb-12 md:py-20">
      ...
      <div className="md:hidden w-11/12 max-w-sm mx-auto relative rounded-lg overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center flex flex-col items-center p-6">
          ...
          >
            SSICRS invites you to be part of the movement that is transforming
            the future of surgery. Whether you&apos;re a{" "}
            <br className="hidden sm:inline-block" />
            surgeon looking to master robotic-assisted techniques, a nurse
            preparing to assist in robotic procedures, or an{" "}
            <br className="hidden sm:inline-block" />
            anesthesiologist ensuring robotic surgery patient safety—SSICRS is
            your gateway to expertise in the most{" "}
            <br className="hidden sm:inline-block" />
      ...
      <div className="hidden md:block relative w-full max-w-[1306px] px-4">
        ...
        <div className="relative flex flex-col justify-center items-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
            ...
            >
              SSICRS invites you to be part of the movement that is transforming
              the future of surgery. Whether you&apos;re a <br />
              surgeon looking to master robotic-assisted techniques, a nurse
              preparing to assist in robotic procedures, or an <br />
              anesthesiologist ensuring robotic surgery patient safety—SSICRS is
              your gateway to expertise in the most <br />
              advanced form of surgery today.
            </p>
