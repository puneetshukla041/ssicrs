    ...
    <section className="w-full bg-white relative flex justify-center items-center py-12 md:py-0">
      ...
      <div className="md:hidden w-11/12 max-w-sm mx-auto flex flex-col items-center justify-center p-6 bg-cover bg-center rounded-lg relative"
        ...
        <div className="relative z-10 text-center flex flex-col items-center">
          ...
          >
            SSICRS invites you to be part of the movement that is transforming the future of surgery. Whether you're a <br/>surgeon looking to master robotic-assisted techniques, a nurse
         preparing to assist in robotic procedures, or an <br/>anesthesiologist ensuring robotic surgery patient safety—SSICRS is your gateway to expertise in the most <br/>advanced form of surgery today.
          </p>
...
<div className="hidden md:block relative flex flex-col justify-center items-center min-h-screen">
  ...
  <h2
    ...
    style={{
      ...
      top: "30%", // moved a bit lower from 30%
      left: "50%",
...
<p
  ...
  style={{
    ...
    whiteSpace: "pre-line", // respect <br/>
  }}
>
  ...
  <button
    ...
    style={{
      top: "68%", // moved a bit lower from 63%
      left: "50%",
      transform: "translate(-50%, -50%)",
      width: "167px",
      height: "43px",
