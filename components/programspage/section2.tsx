        ...
        <div className="mt-8 lg:mt-[20px] flex flex-col lg:flex-row gap-8 lg:gap-[40px] items-center lg:items-start">
          ...
          >
            {containers.map((item, index) => {
                // 5. Use a separate useInView hook for each card for staggered effect
                // NOTE: Use React.useMemo to avoid unnecessary re-creations, though typically useInView handles this internally
                // For simplicity and clarity, we'll keep the direct hook call per item in the map, which is a common pattern.
